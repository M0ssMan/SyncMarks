  ...
  FT.registerExtension({
    ...
    nodeRenderTitle(ctx, title) {
     // set node connector images, links and text
      ...
      let htmlCheckbox;
      if (node.data.syncedTo === undefined || node.data.syncedTo[clientProfile]) {
        htmlCheckbox = /* @html */`
